 ...
 * 
 * Takes an array of column names that should be hidden and makes a mapping of 
 * visible columns to the actual columns in the data.  The overrided methods 
 * of getValueAt(), getColumnCount(), and getColumnName() then use this 
 * mapping.  Values from hidden columns can be obtained by using the actual 
 * column name.
 */
public class HidableDatabaseTableModel extends DatabaseTableModel {
	...
	protected int getDataColumn(int columnIndex) {
